...
void BindCoreTypes(sol::state& lua) {
    ...
    lua.new_usertype<glm::vec2>(
        ...
        [](const glm::vec2& v) { return fmt::format("vec2({}, {})", v.x, v.y); },
    ...
    lua.new_usertype<glm::vec3>(
        ...
        sol::meta_function::to_string,
        [](const glm::vec3& v) { return fmt::format("vec3({}, {}, {})", v.x, v.y, v.z); },
    ...
    lua.new_usertype<glm::vec4>(
        ...
        sol::meta_function::to_string,
        [](const glm::vec4& v) { return fmt::format("vec4({}, {}, {}, {})", v.x, v.y, v.z, v.w); }
    );
    ...
    lua.new_usertype<glm::quat>(
        ...
        // Static constructors
        "fromEuler",
        [](float x, float y, float z) { return glm::quat(glm::vec3(x, y, z)); },
        "fromAxisAngle",
        [](const glm::vec3& axis, float angle) { return glm::angleAxis(angle, axis); }
    );
